...
urlpatterns = [
    ...
    path('dashboard/builder/', admin_panel.dashboard_page_builder, name='dashboard_page_builder'),
    ...
    path('dashboard/bale/scenarios/', admin_panel.dashboard_bale_scenarios, name='dashboard_bale_scenarios'),
    ...
    path('dashboard/roadmap/', admin_panel.dashboard_roadmap, name='dashboard_roadmap'),
    path('dashboard/media/', admin_panel.dashboard_media, name='dashboard_section_media'),
    path('dashboard/media/<int:asset_id>/', admin_panel.dashboard_media_edit, name='dashboard_media_edit'),
    path('dashboard/security/', admin_panel.dashboard_security, name='dashboard_section_security'),
