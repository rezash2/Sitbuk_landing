...
PAGE_CONTENTS = [
    ...
    },
    {
        ...
        'seo_keywords': 'درباره سیتباک, تیم سیتباک, شرکت پیشرو برنامه آمارد',
    ...
    },
    {
        ...
        'page_description': 'مسیر پیاده‌سازی سیتباک؛ از تحلیل نیاز و طراحی جریان تا داشبورد مدیریتی و خروجی قابل اندازه‌گیری.',
...
ITEMS = [
    ...
    ('case_study', 'customer_quote', 'مشتری سازمانی سیتباک', 'مدیر فروش', 'با سیتباک، پیگیری‌های فروش از حالت پراکنده خارج شد و مدیران دید دقیق‌تری به وضعیت تیم پیدا کردند.', '', '', 'quote', '', 1),
    ...
    # Pricing / Plans / FAQ
    ('pricing', 'pricing_highlights', 'شروع مرحله‌ای', '', 'می‌توانید با ماژول‌های ضروری شروع کنید و در ادامه توسعه دهید.', '', '', 'rocket', '', 1),
