...
ITEMS = [
    ...
    ('about', 'leaders', 'مهندس رضا شیروانی', 'کو‌فاندر و مدیر بخش فنی', 'متخصص در معماری سیستم‌ها و توسعه راهکارهای نرم‌افزاری مقیاس‌پذیر.', '', '', 'user-star', 'about_member_reza.png', 1),
    ('about', 'leaders', 'مهندس پویا فریدی', 'کو‌فاندر و عضو هیئت مدیره', 'متخصص در توسعه کسب‌وکار، فروش و استراتژی بازار برای محصولات SaaS.', '', '', 'user-star', 'فریدی.png', 2),
    ('about', 'leaders', 'دکتر مهدی فرامرزیان', 'رئیس هیئت مدیره', 'متخصص در مدیریت، برنامه‌ریزی استراتژیک و توسعه سازمانی.', '', '', 'user-star', 'فرامرزیان.png', 3),
