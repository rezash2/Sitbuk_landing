...
def seed_homepage_cms(apps, schema_editor):
    ...
    rows = [
        ...
        ('stat', 'رضایت کاربران', 'از نرم‌افزارهای سیتباک', '', '۹۸٪', '', 'smile', 1),
        ('stat', 'کسب‌وکار', 'اعتماد کرده‌اند', '', '+۳۳۰', '', 'users', 2),
        ('stat', 'ماژول تخصصی', 'برای نیازهای مختلف و قابل توسعه', '', '۱۲+', '', 'cube', 3),
        ('stat', 'پشتیبانی', 'همیشه در کنار شما', '', '۲۴/۷', '', 'headphones', 4),
