    ...
    data.setdefault('homepage_video_sections', [
        {
            ...
            'description': 'در این بخش می‌بینید که اطلاعات فروش، مالی، منابع انسانی، ارتباط با مشتری و فرآیندهای داخلی در یک بستر واحد به هم متصل می‌شوند تا دوباره‌کاری، جزیره‌ای شدن داده‌ها و خطاهای ناشی از پراکندگی کاهش پیدا کند.',
        ...
        },
        {
            ...
            'description': 'در این بخش می‌بینید که سیت‌باک یک نرم‌افزار ثابت و محدود نیست؛ فرم‌ها، فرآیندها، فیلدها، نقش‌ها و جریان‌های کاری با توجه به نیاز هر کسب‌وکار قابل تنظیم و سفارشی‌سازی هستند.',
